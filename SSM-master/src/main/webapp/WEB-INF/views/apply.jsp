...
<script type="text/javascript" src="style/js/index.bundle.js"></script>
<link rel="stylesheet" href="style/css/materialize-icon.css" />
...
<body>
	<div id="body">
		<div id="header">
			<div class="wrapper">
				<a class="logo" href="index"> <img width="229" height="43"
					alt="拉勾招聘-专注互联网招聘" src="style/images/logo5.png">
				</a>
				<ul id="navheader" class="reset">
					...
					<li><a rel="nofollow" target="_blank"
						href="preview?email=${sessionScope.email}">预览</a></li>
					<li><a href="websocket" rel="nofollow">聊天</a></li>
					<%
						}
					%>
				</ul>
				<dl class="collapsible_menu">
					<dt>
						<span id="ex">${sessionScope.email}</span> <span class="red dn"
					...
					<dd style="display: none;">
						<a href="stuResume">我的简历</a>
					</dd>
					<dd style="display: none;">
						<a href="index">我要找工作</a>
					</dd>
					<dd style="display: none;">
						<a href="updatePwd">帐号设置</a>
					</dd>
					<dd class="logout" style="display: none;">
						<a rel="nofollow" href="outLogin">退出</a>
					</dd>
				</dl>
			</div>
		</div>
					...
					<dl class="job_detail">
						...
						<dd class="job_request">
							<div style="float: left; margin-top: -5px;">
								<span class="red">人数：${resume.number}</span><br /> <br /> <span
									class="red">报酬：${resume.salary}</span><br /> <br /> <span
									class="red">地点：${resume.department}</span>

							</div>
							<a title="报名参加" class="btn fr btn_apply" id="stuApply"
								onclick="checkStudent()">报名参加</a>
							<!--inline-->
						</dd>
						<dd class="job_bt">
							<h3 class="description">职位详情</h3>
							<p>
								<strong>职位详情：</strong>&nbsp;${resume.detail}
							</p>
							<div class="row detail-area">
								<h3 class="description">地理位置</h3>
								<input type="hidden" id="cityName" value="${resume.department}" />
								<!-- <input type="button" onclick="setCity()" value="查找" /> -->
								<div id="container2" style="width: 600px; height: 400px;"></div>

							</div>

							<h3 class="description">要求</h3>
							<p>${resume.deRequest}</p></br>
							<h3 class="description">时间</h3>
							<p>${resume.time}</p>
						...
						<dd class="resume resume_web">
							<div>
								<span> 你已有可投递的在线简历：<a target="_blank"
									href="preview?email=${sessionScope.email}"><strong
										id="stuName"></strong></a></span><br> <span id="upTime"></span>
							</div>
							<span class="setBtns"> <a target="_blank" title="预览"
								href="preview?email=${sessionScope.email}">预览</a> | <a
								title="修改" href="stuResume">修改</a>
							</span>
						</dd>
						<%
							}
					...
					<dl class="job_company">
						<dt>
							<a target="_blank" href="h/c/5004.html"> <img width="80"
								height="80" alt="" src="style/images/company.png" class="b2">
							</a>
							<div style="margin-left: 20px;">
								<h2 class="fl">${company.name}</h2>
							</div>
						...
						<dd>
							<ul class="c_feature reset">
								...
								<li><span>主页</span> <a rel="nofollow" title=""
									target="_blank" href="${company.website}">${company.website}</a>
								</li>
							</ul>
...
var options = {
    	...
    	"load": true};
			...
			<script src="style/js/common1.js" type="text/javascript"></script>
...
$(function(){
	...
	<script type="text/javascript">
	var map = new BMap.Map("container2");        //在container容器中创建一个地图,参数container为div的id属性;
