...
<script type="text/javascript" src="style/js/step6.min.js"></script>
...
<body>
	<div id="body">
		<div id="header">
			<div class="wrapper">
				<a class="logo" href="index.html"> <img width="229" height="43"
					alt="大学生兼职平台-填写公司信息" src="style/images/logo5.png">
				</a>
				...
				<dl class="collapsible_menu">
					...
					<dd class="btm" style="display: none;">
						<a onclick="checkCompany()">我的公司主页</a>
					</dd>
		...
		<div id="container">
			...
			<div style="" id="stepTip">
				<a></a> <img width="803" height="59" src="style/images/tips.jpg">
			</div>
				...
				<dl class="c_section c_section_mid">
					...
					<dd>
						<form id="stepForm">
							...
							<h3>公司名称</h3>
							<input type="text" placeholder="请输入公司名称" name="name" id="name"
								class="valid"> <span class="error"
								style="display: none;" id="beError"></span>
							<h3>公司网址</h3>
							...
							<h3>公司简介</h3>
							<input type="text" placeholder="请输入公司简介" maxlength="300"
								name="temptation" id="temptation">

							<h3>公司负责人</h3>
							<input type="text" placeholder="请输入负责人名字" name="principal"
								id="principal" class="valid">

							<h3>联系方式</h3>
							<input type="text" placeholder="请输入联系方式" value="" name="phone"
								id="phone"> <input type="submit" value="保存" id="stepBtn"
								class="btn_big fr">
						</form>
					</dd>
				</dl>
	...
	<script>
	/* $("#select_industry").on("click",function(ev){
		$(this).next().show();
		ev.stopPropagation();
	});
	
	$("#stepForm").on("click",function(ev){
		$(this).next().show();
		ev.stopPropagation();
	}) */
