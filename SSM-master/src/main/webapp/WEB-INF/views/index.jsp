								...
								.ajax({
									...
									success : function(response) {
										...
										for (var i = 0; i < obj.length; i++) {
											html += '<li class="odd clearfix" style="width:750px;margin-top:8px;"><div class="hot_pos_l" ><div class="mb10"><a href="applyRe?id='
													+ obj[i].id
													+ '" target="_blank" style="text-decoration:blink ">'
													+ obj[i].jobName
													+ '</a></div><div style="float:left;"><span><em class="c7">兼职类型： </em>'
													+ obj[i].jobName
													+ '</span> <br /><span><em class="c7">人数：</em>'
													+ obj[i].number
...
<body>
	<div id="body">
		<div id="header">
			<div class="wrapper">
				<a href="index" class="logo"> <img src="style/images/logo5.png"
					width="229" height="43" alt="大学生兼职平台" />
				</a>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">服务员</a> <a href="#">促销导购</a> <a href="#">打包分拣</a> <a
										href="#">礼仪模特</a> <a href="#">话务客服</a> <a href="#">家教助教</a> <a
										href="#">充场</a> <a href="#">问卷调查</a>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">礼仪模特</a> <a href="#">群众演员</a> <a href="#">演出</a>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">传单派发</a> <a href="#">打包分拣</a> <a href="#">充场</a> <a
										href="#">问卷调查</a> <a href="#">审核录入</a> <a href="#">保洁</a> <a
										href="#">地推拉访</a>
								</dd>
							</dl>
						</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">挂号排队</a> <a href="#">送餐员</a> <a href="#">宠物寄养</a> <a
										href="#">车票代购</a>
								</dd>
							</dl>
						</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">话务客服</a> <a href="#">促销导购</a> <a href="#">文员</a> <a
										href="#">展会协助</a>
								</dd>
							</dl>
						</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">餐饮工</a> <a href="#">服务员</a> <a href="#">安保</a> <a
										href="#">会展执行</a> <a href="#">快递配送</a>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">司机代驾</a> <a href="#">技师技工</a> <a href="#">美容美发</a>
									<a href="#">月嫂阿姨</a> <a href="#">销售房产</a> <a href="#">经纪人</a> <a
										href="#">保险</a> <a href="#">在线老师</a>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">校园代理</a> <a href="#">家教助教</a> <a href="#">健身教练</a>
									<a href="#">翻译</a> <a href="#">婚礼主持</a> <a href="#">摄影摄像</a> <a
										href="#">旅行导游</a> <a href="#">美工设计</a> <a href="#">创意策划</a> <a
										href="#">财务会计</a> <a href="#">项目外包</a> <a href="#">软件开发</a>
								</dd>
							</dl>
						</div>
					</div>
					...
					<div class="menu_box">
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									<a href="#">志愿者</a> <a href="#">救生员</a> <a href="#">实习生</a> <a
										href="#">社会义工</a>
								</dd>
							</dl>
						</div>
			...
			<div class="content">
				<div id="search_box">
					...
					<input type="text" id="search_input" name="kd" tabindex="1"
						value="" placeholder="请输入兼职名称，如：话务客服" /> <input type="submit"
